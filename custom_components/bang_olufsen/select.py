...
from mozart_api.models import ListeningModeProps, ListeningModeRef, SpeakerGroupOverview
...
class BangOlufsenSelectSoundMode(BangOlufsenSelect):
    ...
    async def async_select_option(self, option: str) -> None:
        ...
        await self._client.activate_listening_mode(id=self._sound_modes[option])
