...
async def test_async_browse_media(
    ...
    await mock_mozart_client.send_json_auto_id(
        {
            "type": "media_player/browse_media",
            "entity_id": TEST_MEDIA_PLAYER_ENTITY_ID,
        }
    )
    response = await mock_mozart_client.receive_json()
...
async def test_async_join_players(
    ...
    assert mock_mozart_client.async_post_beolink_expand.call_count == expand_count
...
async def test_async_beolink_expand(
    ...
    mock_mozart_client.async_post_beolink_expand.return_value = expand_response
    ...
    assert mock_mozart_client.async_post_beolink_expand.call_count == len(
